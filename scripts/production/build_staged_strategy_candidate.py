...
def _build_manifest(
    *,
    ...
    return {
        ...
        "truth_contract_expectations": expected_truth_contract_state(),
        "truth_contract_current": read_truth_contract_state(root=ROOT),
...
def main() -> None:
    ...
    protected_before = capture_protected_state(root=ROOT)
    ...
    protected_after = capture_protected_state(root=ROOT)
