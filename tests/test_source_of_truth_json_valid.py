...
class TestSourceOfTruthJsonValid(unittest.TestCase):
    ...
    def test_export_contract_contains_normalized_public_runtime_contracts(self):
        ...
        self.assertEqual(public_strategy_chart_semantics.get("upper_line"), "model_index")
        ...
        self.assertEqual(live_strategy_chart_semantics.get("lower_strip"), "live_strategy_exposure_x")
        self.assertEqual(live_strategy_chart_semantics.get("source_field"), "live_strategy_source")
    ...
    def test_paths_registry_contains_dashboard_public_artifacts(self):
        ...
        self.assertEqual(public_strategy_chart_pair.get("upper_line"), "model_index")
        self.assertEqual(public_strategy_chart_pair.get("btc_line"), "btc_index")
        self.assertEqual(public_strategy_chart_pair.get("lower_strip"), "model_authorized_exposure_x")
        self.assertEqual(public_strategy_chart_pair.get("source_label"), "model_strategy_full_history")
        live_strategy_chart_pair = chart_field_contract.get("live_strategy_chart_pair")
        self.assertIsInstance(live_strategy_chart_pair, dict)
        self.assertEqual(live_strategy_chart_pair.get("upper_line"), "live_strategy_index")
        self.assertEqual(live_strategy_chart_pair.get("lower_strip"), "live_strategy_exposure_x")
        self.assertEqual(live_strategy_chart_pair.get("source_field"), "live_strategy_source")
