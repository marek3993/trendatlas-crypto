...
OUT_BASE_CSV = OUTPUT_DIR / "phase36_old_baseline_daily.csv"
OUT_WINNER_CSV = OUTPUT_DIR / "phase36_new_winner_daily.csv"
OUT_COMPARE_WINDOWS_CSV = OUTPUT_DIR / "phase36_compare_focus_windows.csv"
OUT_MISSED_DETAIL_CSV = OUTPUT_DIR / "phase36_new_winner_missed_run_detail.csv"
OUT_MISSED_WINDOWS_CSV = OUTPUT_DIR / "phase36_new_winner_missed_run_windows.csv"
OUT_SUMMARY_JSON = OUTPUT_DIR / "phase36_new_winner_summary.json"
...
def main() -> None:
    ...
    print("počítam new winner tables...", flush=True)
