...
OUT_DIR = OUTPUTS / "phase56_phase42_profit_lock"
...
MODEL_LABELS = {
    "phase56_phase42_core": "Phase42 core",
    "phase56_profit_lock_light": "Profit lock light",
    "phase56_profit_lock_medium": "Profit lock medium",
    "phase56_profit_lock_strict": "Profit lock strict",
}

LOCK_RULES = {
    "phase56_phase42_core": None,
    "phase56_profit_lock_light": {"ret10_min": 0.18, "st_max": 12.0, "accel_max": -8.0},
    "phase56_profit_lock_medium": {"ret10_min": 0.15, "st_max": 18.0, "accel_max": -4.0},
    "phase56_profit_lock_strict": {"ret10_min": 0.12, "st_max": 24.0, "accel_max": 0.0},
}
...
def select_daily_top1_variant(asset_tables: dict[str, pd.DataFrame], model_key: str) -> pd.DataFrame:
    ...
    for dt in all_dates:
        ...
        if (
            model_key != "phase56_phase42_core"
...
def main() -> None:
    ...
    variants = [
        "phase56_phase42_core",
        "phase56_profit_lock_light",
        "phase56_profit_lock_medium",
        "phase56_profit_lock_strict",
    ]
    ...
    summary_df.to_csv(OUT_DIR / "phase56_phase42_profit_lock_summary.csv", index=False)
    ...
    eq = eq.reset_index()
    eq.to_csv(OUT_DIR / "phase56_phase42_profit_lock_equity_curves.csv", index=False)

    print("\n=== PHASE56 PHASE42 PROFIT LOCK ===\n")
    print(summary_df.to_string(index=False))
    print(f"\nSaved summary: {OUT_DIR / 'phase56_phase42_profit_lock_summary.csv'}")
    print(f"Saved equity curves: {OUT_DIR / 'phase56_phase42_profit_lock_equity_curves.csv'}")
