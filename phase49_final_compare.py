...
OUT_DIR = OUTPUTS / "phase49_final_compare"
...
MODEL_LABELS = {
    "phase49_no_bnb_baseline": "No BNB baseline",
    "phase49_bnb_hybrid_base": "BNB hybrid base",
    "phase49_bnb_hybrid_strict": "BNB hybrid strict",
}

VARIANT_RULES = {
    "no_bnb_baseline": None,
    "bnb_hybrid_base": {"lt_min": 45.0, "st_min": 35.0, "xs20_min": 20.0, "gap_min": None},
    "bnb_hybrid_strict": {"lt_min": 55.0, "st_min": 40.0, "xs20_min": 30.0, "gap_min": None},
}
...
def main() -> None:
    ...
    variants = [
        ("phase49_no_bnb_baseline", "no_bnb_baseline"),
        ("phase49_bnb_hybrid_base", "bnb_hybrid_base"),
        ("phase49_bnb_hybrid_strict", "bnb_hybrid_strict"),
    ]
    ...
    summary_df.to_csv(OUT_DIR / "phase49_final_compare_summary.csv", index=False)
    ...
    eq = eq.reset_index()
    eq.to_csv(OUT_DIR / "phase49_final_compare_equity_curves.csv", index=False)

    print("\n=== PHASE49 FINAL COMPARE SUMMARY ===\n")
    print(summary_df.to_string(index=False))
    print(f"\nSaved summary: {OUT_DIR / 'phase49_final_compare_summary.csv'}")
    print(f"Saved equity curves: {OUT_DIR / 'phase49_final_compare_equity_curves.csv'}")
