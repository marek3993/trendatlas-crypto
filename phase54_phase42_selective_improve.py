...
OUT_DIR = OUTPUTS / "phase54_phase42_selective_improve"
...
MODEL_LABELS = {
    "phase54_phase42_core": "Phase42 core",
    "phase54_phase42_bnb_trend_base": "Phase42 + BNB trend base",
    "phase54_phase42_bnb_trend_strict": "Phase42 + BNB trend strict",
    "phase54_phase42_bnb_trend_gap": "Phase42 + BNB trend+gap",
}
...
VARIANT_RULES = {
    ...
    "bnb_trend_gap": {"lt_min": 45.0, "st_min": 35.0, "xs20_min": 20.0, "gap_min": 8.0},
}
...
def main() -> None:
    ...
    variants = [
        ("phase54_phase42_core", "phase42_core"),
        ("phase54_phase42_bnb_trend_base", "bnb_trend_base"),
        ("phase54_phase42_bnb_trend_strict", "bnb_trend_strict"),
        ("phase54_phase42_bnb_trend_gap", "bnb_trend_gap"),
    ]
    ...
    summary_df.to_csv(OUT_DIR / "phase54_phase42_selective_improve_summary.csv", index=False)
    ...
    eq = eq.reset_index()
    eq.to_csv(OUT_DIR / "phase54_phase42_selective_improve_equity_curves.csv", index=False)

    print("\n=== PHASE54 PHASE42 SELECTIVE IMPROVE ===\n")
    print(summary_df.to_string(index=False))
    print(f"\nSaved summary: {OUT_DIR / 'phase54_phase42_selective_improve_summary.csv'}")
    print(f"Saved equity curves: {OUT_DIR / 'phase54_phase42_selective_improve_equity_curves.csv'}")
